...
**Windows の場合：**
- [https://git-scm.com/download/win](https://git-scm.com/download/win) からインストーラーをダウンロード・実行
...
1. [https://code.visualstudio.com/](https://code.visualstudio.com/) からVSCodeをインストール
...
├── terraform/                   # GCPインフラ設定
└── docs/                        # 手順書類
    ├── github-guide.md          # このファイル
    └── SETUP.md                 # システムセットアップ手順
```
